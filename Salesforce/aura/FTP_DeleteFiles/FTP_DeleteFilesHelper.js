({
	deleteFiles : function(component, event) {
		this.startWaiting(component);
        var action = component.get("c.deleteFilesFromFtpServer");
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
                ...
                //this.showToastMessage(component, event, 'Success', "File Deleted Successfully!", 'success');
            }else if (state === "ERROR") {
